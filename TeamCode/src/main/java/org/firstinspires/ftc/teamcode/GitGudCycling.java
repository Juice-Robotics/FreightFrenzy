 ...
 * class GitGudCycling instantiated on the Robot Controller and executed.
 *
...
@Autonomous(name = "Git Gud Cycling", group = "auton")
public class GitGudCycling extends LinearOpMode {
    Robot robot;
    ...
    public void runOpMode() throws InterruptedException {
         ...
         * dashboard.addConfigVariable("PIDController", "armPID2",
         * robot.v4bArm.armPID2);
         */
        ...
        while (opModeIsActive() && !isStopRequested()) {
            ...
            if (go == 0) {
                ...
                if ((robot.v4bArm.armMotor1.getEncoderValue() > armVal + 10)
                        && (robot.v4bArm.armMotor1.getEncoderValue() < armVal - 10)) {
                    // if ( robot.v4bArm.armMotor1.getEncoderValue() > armVal){
