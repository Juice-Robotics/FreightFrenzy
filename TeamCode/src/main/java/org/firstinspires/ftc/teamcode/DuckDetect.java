...
public class DuckDetect extends LinearOpMode {

    private OpenCvCamera webcam;
    private DuckDetectPipeline pipeline;
    ...
    public void runOpMode() throws InterruptedException
    {
        ...
        pipeline = new DuckDetectPipeline(0.2, 0.2, 0.2, 0.2);
    ...
    public void testing(DuckDetectPipeline pipeline){
